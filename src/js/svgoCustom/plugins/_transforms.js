 ...
 */
export var transform2js = function (transformString) {
 ...
 */
export var transformsMultiply = function (transforms) {
 ...
 */
export var matrixToTransform = function (transform, params) {
 ...
 */
export var transformArc = function (arc, transform) {
  var a = arc[0],
    b = arc[1],
