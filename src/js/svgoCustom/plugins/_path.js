...
import { transform2js } from "./_transforms";
import { transformsMultiply } from "./_transforms";
import { transformArc } from "./_transforms";
import { referencesProps, attrsGroupsDefaults } from "./_collections.js";
import { cleanupOutData, removeLeadingZero } from "../lib/svgo/tools";
 ...
 */
export var path2js = function (path) {
 ...
 */
export var relative2absolute = function (data) {
 ...
 */
export var applyTransforms = function (elem, path, params) {
 ...
 * @return {Object}
 */
export var computeCubicBoundingBox = function (xa, ya, xb, yb, xc, yc, xd, yd) {
 ...
 * @return {Object}
 */
export var computeQuadraticBoundingBox = function (xa, ya, xb, yb, xc, yc) {
  var minx = Number.POSITIVE_INFINITY,
    miny = Number.POSITIVE_INFINITY,
    maxx = Number.NEGATIVE_INFINITY,
    maxy = Number.NEGATIVE_INFINITY,
 ...
 */
export var js2path = function (path, data, params) {
  path.pathJS = data;
 ...
 * @return {Boolean}
 */
export var intersects = function (path1, path2) {
