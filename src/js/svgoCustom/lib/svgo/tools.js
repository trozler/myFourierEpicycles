 ...
 */
export var encodeSVGDatauri = function (str, type) {
 ...
 * @return {String} output string
 */
export var decodeSVGDatauri = function (str) {
...
export var intersectArrays = function (a, b) {
 ...
 * @return {string}
 */
export var cleanupOutData = function (data, params, command) {
  var str = "",
    delimiter,
    prev;
 ...
 */
export var removeLeadingZero = function (num) {
